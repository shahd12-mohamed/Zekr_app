...
class Zekr7 extends StatefulWidget {


  @override
  State<Zekr7> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr7> {
  int _counter = 0;
      ...
      body: Center(
        child: Column(
          ...
          children: [
             ...
             mytext(message: "اللَّهُمَّ صَلِّ وَسَلِّمْ على نَبِيِّنَا مُحمَّد",fontStyle: FontStyle.normal, size: 30,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
