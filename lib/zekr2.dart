...
class Zekr2 extends StatefulWidget {
  ...
  @override
  State<Zekr2> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr2> {
  int counter=0;
      ...
      body: Center(
        child: Column(
          ...
          children: [
           ...
           mytext(message: "أستغفر الله",fontStyle: FontStyle.normal, size: 50,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
           SizedBox(height: 10,) ,
