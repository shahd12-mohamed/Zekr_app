...
class Zekr8 extends StatefulWidget {


  @override
  State<Zekr8> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr8> {
  int _counter = 0;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: mytext(message: "أَعـوذُ بِكَلِمـاتِ اللّهِ التّـامّـاتِ مِنْ شَـرِّ ما خَلَـق",fontStyle: FontStyle.normal, size: 35,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
            ),
           SizedBox(height: 10,) ,
