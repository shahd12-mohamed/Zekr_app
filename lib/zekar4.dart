...
class Zekr4 extends StatefulWidget {


  @override
  State<Zekr4> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr4> {
  int _counter = 0;
      ...
      body: Center(
        child: Column(
          ...
          children: [
           ...
           mytext(message: "الحمدُ للَّهِ",fontStyle: FontStyle.normal, size: 50,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
           SizedBox(height: 10,) ,
