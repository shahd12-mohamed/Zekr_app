...
class Zekr3 extends StatefulWidget {


  @override
  State<Zekr3> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr3> {
  int _counter = 0;
      ...
      body: Center(
        child: Column(
          ...
          children: [
           ...
           mytext(message: "الْلَّهُ أَكْبَر",fontStyle: FontStyle.normal, size: 50,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
           SizedBox(height: 10,) ,
