...
class Zekr5 extends StatefulWidget {


  @override
  State<Zekr5> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Zekr5> {
  int _counter = 0;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: mytext(message: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ ، سُبْحَانَ اللَّهِ الْعَظِيمِ",fontStyle: FontStyle.normal, size: 40,fontWeight: FontWeight.bold,color:Color.fromARGB(255, 36, 7, 116)),
            ),
           SizedBox(height: 10,) ,
